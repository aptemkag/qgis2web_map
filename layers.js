...
lyr_highway_secondary_9.set('fieldLabels', {'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'highway': 'no label', 'layer': 'no label', 'bridge': 'no label', 'name:etymology:wikidata': 'no label', 'surface': 'no label', 'ref': 'no label', 'oneway': 'no label', 'name:ru': 'no label', 'name:en': 'no label', 'name': 'no label', 'maxspeed': 'no label', 'lanes': 'no label', });
